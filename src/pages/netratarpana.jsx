...
export default function Netratarpana() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <nav aria-label="Breadcrumb" className="mb-4 -mt-5 md:mt-0">
            <ol className="flex items-center justify-center text-sm text-gray-500 space-x-2">
                ...
                <li className="text-gray-400"><FaChevronRight className="inline w-3 h-3 mx-1" /></li>
                <li className="text-gray-700">Netratarpana</li>
              </ol>
          </nav>
          ...
          <header className="mb-8 text-center">
            <h1 className="text-3xl sm:text-4xl font-extrabold" style={{ fontFamily: "'Playfair Display', serif" }}>
              <span className="text-emerald-600">Netratarpana</span>
              <span className="text-black font-semibold"> — Eye Treatment</span>
            </h1>
          </header>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="w-full">
              <img
                src="/images/netratarpana.webp"
                alt="Netratarpana treatment - eye therapy"
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <p className="text-gray-700 mb-4" style={{ fontFamily: "Inter, system-ui, -apple-system, 'Helvetica Neue', Arial" }}>
                Netratarpana is a specialized Ayurvedic eye treatment that involves the application of warm medicated ghee around the eyes. This soothing therapy helps to improve vision, relieve eye strain, and promote relaxation. Netratarpana is particularly beneficial for those who spend long hours in front of screens or suffer from dry eyes.
              </p>
          ...
          <section className="mt-12">
            ...
            <motion.div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Relieves Eye Strain</h3>
                  <p className="text-gray-600 text-sm">Soothes tired eyes and reduces strain caused by long screen use or reading.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Improves Tear Film & Dry Eyes</h3>
                  <p className="text-gray-600 text-sm">Helps relieve dryness by nourishing the ocular surface and improving lubrication.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Enhances Visual Clarity</h3>
                  <p className="text-gray-600 text-sm">Supports clearer vision by nourishing ocular tissues and reducing peripheral strain.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Reduces Headache & Fatigue</h3>
                  <p className="text-gray-600 text-sm">Alleviates associated headaches and mental fatigue by calming the ocular and nervous systems.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Nourishes Periocular Skin</h3>
                  <p className="text-gray-600 text-sm">Deeply nourishes the delicate skin around the eyes, reducing dryness and fine lines.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Promotes Relaxation & Sleep</h3>
                  <p className="text-gray-600 text-sm">Calms the nervous system and promotes restful sleep when included as part of a treatment plan.</p>
                </div>
              </motion.div>
            </motion.div>
          </section>
