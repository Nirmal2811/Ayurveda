...
export default function Njavarakizhi() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <nav aria-label="Breadcrumb" className="mb-4 -mt-5 md:mt-0">
            <ol className="flex items-center justify-center text-sm text-gray-500 space-x-2">
                ...
                <li className="text-gray-400"><FaChevronRight className="inline w-3 h-3 mx-1" /></li>
                <li className="text-gray-700">Njavarakizhi</li>
              </ol>
          </nav>
          ...
          <header className="mb-8 text-center">
            <h1 className="text-3xl sm:text-4xl font-extrabold" style={{ fontFamily: "'Playfair Display', serif" }}>
              <span className="text-emerald-600">Njavarakizhi</span>
              <span className="text-black font-semibold"> — Rice Pouch Massage</span>
            </h1>
          </header>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="w-full">
              <img
                src="/images/njavarakizhi.webp"
                alt="Njavarakizhi treatment - rice pouch massage"
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <p className="text-gray-700 mb-4" style={{ fontFamily: "Inter, system-ui, -apple-system, 'Helvetica Neue', Arial" }}>
                Njavarakizhi is a traditional Ayurvedic treatment that involves the use of rice poultices filled with medicinal herbs, which are then heated and applied to the body. This therapy aims to nourish the tissues, improve circulation, and promote relaxation. The warmth of the poultices helps to open up the channels in the body, allowing for better absorption of the herbal properties.
              </p>
          ...
          <section className="mt-12">
            ...
            <motion.div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Deep Tissue Nourishment</h3>
                  <p className="text-gray-600 text-sm">Heated rice poultices transfer herbal nourishment deeply into tissues, improving tone and vitality.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">The warmth from the poultices stimulates microcirculation, aiding healing and toxin removal.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Pain Relief & Muscle Relaxation</h3>
                  <p className="text-gray-600 text-sm">Eases chronic pain and relaxes tight muscles through gentle heat and herbal action.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Detoxification Support</h3>
                  <p className="text-gray-600 text-sm">Supports gentle detox by opening channels and helping the body eliminate metabolic waste.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Improved Mobility</h3>
                  <p className="text-gray-600 text-sm">Regular sessions can increase flexibility and joint mobility by reducing stiffness and nourishing connective tissue.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Rejuvenation & Radiance</h3>
                  <p className="text-gray-600 text-sm">Nourishes skin and tissues to impart a healthier, more radiant appearance and a sense of rejuvenation.</p>
                </div>
              </motion.div>
            </motion.div>
          </section>
