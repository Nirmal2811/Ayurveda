...
export default function Januvasti() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <nav aria-label="Breadcrumb" className="mb-4 -mt-5 md:mt-0">
            <ol className="flex items-center justify-center text-sm text-gray-500 space-x-2">
                ...
                <li className="text-gray-400"><FaChevronRight className="inline w-3 h-3 mx-1" /></li>
                <li className="text-gray-700">Januvasti</li>
              </ol>
          </nav>
          ...
          <header className="mb-8 text-center">
            <h1 className="text-3xl sm:text-4xl font-extrabold" style={{ fontFamily: "'Playfair Display', serif" }}>
              <span className="text-emerald-600">Januvasti</span>
              <span className="text-black font-semibold"> — Knee Oil Treatment</span>
            </h1>
          </header>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <p className="text-gray-700 mb-4" style={{ fontFamily: "Inter, system-ui, -apple-system, 'Helvetica Neue', Arial" }}>
                Januvasti is a traditional Ayurvedic treatment that involves the application of warm medicated oil to the knee area, promoting healing and alleviating pain. This therapy is particularly beneficial for individuals suffering from knee discomfort, arthritis, or stiffness. The warmth of the oil helps to improve circulation, reduce inflammation, and enhance mobility in the affected joint.
              </p>
          ...
          <section className="mt-12">
            ...
            <motion.div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Pain & Mobility</h3>
                  <p className="text-gray-600 text-sm">Reduces knee pain and improves joint mobility through the application of warmed medicated oils.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Enhances blood flow around the knee to support healing and nutrient delivery to soft tissues.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Reduced Inflammation</h3>
                  <p className="text-gray-600 text-sm">Helps decrease swelling and inflammation in the joint, easing discomfort and stiffness.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Promotes healthy skin and a radiant complexion in the treated area by deeply nourishing tissues.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Helps regulate sleep patterns and reduce insomnia by easing pain and promoting relaxation.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Rejuvenation</h3>
                  <p className="text-gray-600 text-sm">Supports overall rejuvenation of soft tissues and provides lasting relief from chronic stiffness.</p>
                </div>
              </motion.div>
            </motion.div>
          </section>
