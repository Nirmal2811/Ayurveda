        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <nav aria-label="Breadcrumb" className="mb-4 -mt-5 md:mt-0">
            <ol className="flex items-center justify-center text-sm text-gray-500 space-x-2">
                ...
                <li className="text-gray-400"><FaChevronRight className="inline w-3 h-3 mx-1" /></li>
                <li className="text-gray-700">Shirodhara</li>
              </ol>
          </nav>
          ...
          <header className="mb-8 text-center">
            <h1 className="text-3xl sm:text-4xl font-extrabold" style={{ fontFamily: "'Playfair Display', serif" }}>
              <span className="text-emerald-600">Shirodhara</span>
              <span className="text-black font-semibold"> — Flowing Oil Treatment</span>
            </h1>
          </header>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <p className="text-gray-700 mb-4" style={{ fontFamily: "Inter, system-ui, -apple-system, 'Helvetica Neue', Arial" }}>
                Shirodhara is a traditional Ayurvedic treatment that involves gently pouring warm herbal oil over the forehead in a continuous stream. This deeply relaxing therapy helps to calm the mind, reduce stress, and promote mental clarity. Regular Shirodhara sessions can enhance overall well-being and support emotional balance.
              </p>

              <ul className="space-y-3 mb-6">
                <li className="flex items-start">
                  <FaLeaf className="text-emerald-500 mt-1 mr-3" />
                  <span className="text-gray-700">Gentle, continuous stream of warm herbal oil applied to the forehead to soothe the nervous system.</span>
                </li>
                <li className="flex items-start">
                  <FaClock className="text-emerald-500 mt-1 mr-3" />
                  <span className="text-gray-700">Ideal for reducing stress, alleviating insomnia, and relieving tension headaches.</span>
                </li>
                <li className="flex items-start">
                  <FaCheckCircle className="text-emerald-500 mt-1 mr-3" />
                  <span className="text-gray-700">Promotes mental clarity, emotional balance, and deep relaxation.</span>
                </li>
              </ul>
          ...
          <section className="mt-12">
            ...
            <motion.div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Deep relaxation</h3>
                  <p className="text-gray-600 text-sm">Calms the nervous system and reduces stress and anxiety.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Helps relieve insomnia and supports deeper, more restorative sleep.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Mental clarity</h3>
                  <p className="text-gray-600 text-sm">Enhances concentration, focus and a clear, calm mind.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Headache relief</h3>
                  <p className="text-gray-600 text-sm">Soothes chronic tension and can reduce the frequency of migraines and headaches.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Supports mood regulation and helps reduce irritability and emotional reactivity.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Scalp & hair nourishment</h3>
                  <p className="text-gray-600 text-sm">Nourishes the scalp and hair, improving texture and promoting healthy growth.</p>
                </div>
              </motion.div>
            </motion.div>
          </section>
