...
export default function Nasyam() {
  return (
    <>
      <Header />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <nav aria-label="Breadcrumb" className="mb-4 -mt-5 md:mt-0">
            <ol className="flex items-center justify-center text-sm text-gray-500 space-x-2">
                ...
                <li className="text-gray-400"><FaChevronRight className="inline w-3 h-3 mx-1" /></li>
                <li className="text-gray-700">Nasyam</li>
              </ol>
          </nav>
          ...
          <header className="mb-8 text-center">
            <h1 className="text-3xl sm:text-4xl font-extrabold" style={{ fontFamily: "'Playfair Display', serif" }}>
              <span className="text-emerald-600">Nasyam</span>
              <span className="text-black font-semibold"> — Nasal Cleansing Therapy </span>
            </h1>
          </header>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="w-full">
              <img
                src="/images/nasyam.jpg"
                alt="Nasyam treatment - nasal cleansing therapy"
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <p className="text-gray-700 mb-4" style={{ fontFamily: "Inter, system-ui, -apple-system, 'Helvetica Neue', Arial" }}>
                Nasyam is an Ayurvedic nasal cleansing therapy that involves the administration of medicated oils or herbal preparations through the nostrils. This treatment helps to clear the nasal passages, improve respiratory function, and enhance mental clarity. Nasyam is beneficial for alleviating sinus congestion, headaches, and stress, promoting overall well-being.
              </p>
          ...
          <section className="mt-12">
            ...
            <motion.div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true, amount: 0.2 }}>
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Clears nasal congestion</h3>
                  <p className="text-gray-600 text-sm">Helps remove mucus and debris from the nasal passages for easier breathing.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Improved respiratory function</h3>
                  <p className="text-gray-600 text-sm">Supports clearer airways and can ease breathing difficulties related to congestion.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Sinus relief</h3>
                  <p className="text-gray-600 text-sm">Alleviates sinus pressure and reduces recurring sinus congestion when used regularly.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Enhanced smell & taste</h3>
                  <p className="text-gray-600 text-sm">Clearing the nasal passages can help restore and sharpen the senses of smell and taste.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Reduces headaches</h3>
                  <p className="text-gray-600 text-sm">Can relieve sinus-related headaches and reduce frequency of tension headaches.</p>
                </div>
              </motion.div>
              ...
              <motion.div className="flex items-start space-x-3 p-4 bg-white rounded-lg shadow-sm" whileHover={{ scale: 1.02 }} transition={{ type: 'spring', stiffness: 200 }}>
                <FaLeaf className="text-emerald-500 w-6 h-6 mt-1" />
                <div>
                  <h3 className="font-medium text-gray-900">Balances head doshas</h3>
                  <p className="text-gray-600 text-sm">Helps balance Vata/Pitta in the head region, supporting long-term respiratory wellness.</p>
                </div>
              </motion.div>
            </motion.div>
          </section>
